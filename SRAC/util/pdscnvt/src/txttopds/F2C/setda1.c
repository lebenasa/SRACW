/* setda1.f -- translated by f2c (version 20100827).
...
/* ----------------------------------------------------------------------- */
/*     DIMENSION WORK(6),IWORK(1),CWORK(1) */
/*     EQUIVALENCE (WORK(1),IWORK(1),CWORK(1)) */
/*     CHARACTER LINE*72, CWORK*4 */
/*     LINE = ' 1.00000E+02 CASE               125 -3.00000E-12' */
/*     LD = 4 */
/*     KPOS = 100 */
/*     CALL SETDA1(LINE,LD,WORK,KPOS) */
/*     WRITE(6,*) (WORK(I),I=1,LD) */
/*     WRITE(6,*) (IWORK(I),I=1,LD) */
/*     WRITE(6,*) (CWORK(I),I=1,LD) */
/*     STOP */
/*     END */
/* ----------------------------------------------------------------------- */
/*     SETDA1 : SET DATA FROM TEXT LINE(A72) INCLUDING INTEGER OR */
/*              FLOATING NUMBER OR CHRACTER DATA IN MEMBER ----DN-T */
/*              SAMPLE: */
/*               1.00000E+02 CASE               125 -3.00000E-12 ....... */
/* ----------------------------------------------------------------------- */
/* Subroutine */ int setda1_(char *line, integer *ld, real *data, integer *
