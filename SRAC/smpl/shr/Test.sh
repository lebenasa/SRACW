...
#
   ...
   set WKDR     = $SRAC_DIR/SRACtmp.$CASE.$DATE
   mkdir $WKDR
#
#-- File allocation
...
D:/SRACs/SRACLIB-EDF70/pds/pfast   Old  File
D:/SRACs/SRACLIB-EDF70/pds/pthml   O    F
D:/SRACs/SRACLIB-EDF70/pds/pmcrs   O    F
